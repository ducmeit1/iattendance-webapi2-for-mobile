...
namespace IAttendanceWebAPI.Controllers.Api
{
    ...
    public class AccountController : ApiController
    {
        ...
        public IHttpActionResult GetUserInfo()
        {
            ...
            {
                UserId = identityClaims.FindFirstValue("Id"),
                Username = identityClaims.FindFirstValue("Username"),
                Email = identityClaims.FindFirst("Email").Value,
                Name = identityClaims.FindFirst("Name").Value,
                LoggedOn = identityClaims.FindFirst("LoggedOn").Value,
                DateOfBirth = identityClaims.FindFirstValue("DateOfBirth"),
                Roles = identityClaims.FindAll(ClaimTypes.Role).Select(c => c.Value).Distinct()
            });
        }
